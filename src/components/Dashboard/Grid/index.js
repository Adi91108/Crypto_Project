            ...
            >
                <div className="cointainer-flex">
                    <div className="info-flex">
                        <img src={coin.image} className="coin-logo" alt="brand-img"/>
...
// toLocaleString() is used to add coma in prices and other things and it rounded off the value a little.
